...
<script type="text/javascript">
	function jump() {
		...
		location.href = "${pageContext.request.contextPath }/users/findActivity.action?pNum="
				+ pNum;
 ...
 <nav class="navbar navbar-default g-navbar-s" role="navigation">
    ...
    <div class="container collapse navbar-collapse navbar-ex3-collapse">
      <div class="container g-nav">
        <ul class="nav navbar-nav">
          ...
          <li class=bg1><a href="${pageContext.request.contextPath }/users/findActivity.action">有活动</a></li>
  ...
  <div id="content" class="container">
	...
	<c:if test="${not empty pageBean.articlesCustoms}">
	  <form action ="${pageContext.request.contextPath }/users/findArticlesByCondition.action?category=有活动" method="post">
      <!-- 选择条件查询字段 -->
	...
	<c:forEach items="${pageBean.articlesCustoms}" var="articlesCustom">
          <div class="section">
            ...
            <p class="ifo"><span><date:date value ="${articlesCustom.created}"/></span>/<strong>${articlesCustom.views}</strong>人气/<em>9</em><a href="${pageContext.request.contextPath }/usersfindArticlesCustomByAid.action?aid=${articlesCustom.aid}">评论</a>
             <a  href="${pageContext.request.contextPath }/users/addPraise.action?aid=${articlesCustom.aid}&count=${articlesCustom.count}&category=有活动">点赞${articlesCustom.count }</a>
            </p>
           ...
           <tr>
				<td colspan="9" align="center">
					<!-- 显示首页 --> <c:if test="${pageBean.pNum==1}">
						...
						<a
							href="${pageContext.request.contextPath }/users/findActivity.action?pNum=1">首页</a>
						<a
							href="${pageContext.request.contextPath }/users/findActivity.action?pNum=${pageBean.pNum-1 }">上一页</a>
               ...
               ${i}
						...
						<c:if test="${pageBean.pNum!=i}">
							<a
								href="${pageContext.request.contextPath }/users/findActivity.action?pNum=${i} ">${i}
							</a>
						</c:if>
						...
						<a
							href="${pageContext.request.contextPath }/users/findActivity.action?pNum=${pageBean.pNum+1}">下一页</a>
						<a
							href="${pageContext.request.contextPath }/users/findActivity.action?pNum=${ pageBean.totalPageNum}">尾页</a>
