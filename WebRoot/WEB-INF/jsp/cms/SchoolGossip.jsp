...
<jsp:param name="page_tag" value="schoolLife"/>
 ...
 <script type="text/javascript">
	function jump() {
		...
		location.href = "${pageContext.request.contextPath }/users/findSchoolGossip.action?pNum="
				+ pNum;
      ...
      <div class="container g-nav">
        <ul class="nav navbar-nav">
         <li><a href="${pageContext.request.contextPath }/users/schoolLife.action">首页</a></li>
          ...
          <li class="bg1"><a href="${pageContext.request.contextPath }/users/findSchoolGossip.action">校园八卦</a></li>
  ...
  <div id="content" class="container">
	...
	<c:if test="${not empty pageBean.articlesCustoms}">
     <form action ="${pageContext.request.contextPath }/users/findArticlesByCondition.action?category=校园八卦" method="post">
      <!-- 选择条件查询字段 -->
      ...
      <c:forEach items="${pageBean.articlesCustoms}" var="articlesCustom">
          <div class="section">
           ...
           <a  href="${pageContext.request.contextPath }/users/addPraise.action?aid=${articlesCustom.aid}&count=${articlesCustom.count}&category=校园八卦">点赞${articlesCustom.count }</a>
           </p>
              ...
              <tr>
				<td colspan="9" align="center">
					<!-- 显示首页 --> <c:if test="${pageBean.pNum==1}">
						...
						<a
							href="${pageContext.request.contextPath }/users/findSchoolGossip.action?pNum=1">首页</a>
						<a
							href="${pageContext.request.contextPath }/users/findSchoolGossip.action?pNum=${pageBean.pNum-1 }">上一页</a>
               ...
               ${i}
						...
						<c:if test="${pageBean.pNum!=i}">
							<a
								href="${pageContext.request.contextPath }/users/findSchoolGossip.action?pNum=${i} ">${i}
							</a>
						</c:if>
						...
						<a
							href="${pageContext.request.contextPath }/users/findSchoolGossip.action?pNum=${pageBean.pNum+1}">下一页</a>
						<a
							href="${pageContext.request.contextPath }/users/findSchoolGossip.action?pNum=${ pageBean.totalPageNum}">尾页</a>
