...
<script type="text/javascript">
	function jump() {
		...
		location.href = "${pageContext.request.contextPath }/findByPageNotes.action?pNum="
				+ pNum;
	}
	// 按钮 全部选中，全部取消
								...
								<div class="widget-content nopadding">
									...
									<div class="pagination alternate text-center">
										<ul>
											...
											<c:if test="${pageBean.pNum != 1}">
												<li><a
													href="${pageContext.request.contextPath }/findByPageNotes.action?pNum=1">首页</a></li>
												<li><a
													href="${pageContext.request.contextPath }/findByPageNotes.action?pNum=${pageBean.pNum-1 }">
														上一页</a></li>
											</c:if>
											<!-- 当前页为中心前后各显示10页 -->
											...
											<c:forEach begin="${begin}" end="${end}" var="i">
												...
												<c:if test="${pageBean.pNum!=i}">
													<li><a
														href="${pageContext.request.contextPath }/findByPageNotes.action?pNum=${i }">${i
															} </a></li>
												</c:if>
											</c:forEach>
											<!-- 显示尾页 -->
											...
											<c:if test="${pageBean.pNum != pageBean.totalPageNum}">
												<li><a
													href="${pageContext.request.contextPath }/findByPageNotes.action?pNum=${pageBean.pNum + 1 }">下一页</a></li>
												<li><a
													href="${pageContext.request.contextPath }/findByPageNotes.action?pNum=${pageBean.totalPageNum}">尾页</a></li>
											</c:if>
										</ul>
