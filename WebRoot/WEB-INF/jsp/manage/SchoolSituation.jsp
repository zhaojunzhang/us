...
<script type="text/javascript">
	function jump() {
		...
		location.href = "${pageContext.request.contextPath }/admins/findSchoolSituation.action?pNum="
				+ pNum;
 ...
 <!--top-Header-menu-->
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.html" title="回到主页" class="tip-bottom"><i class="icon-home"></i>主页</a> <a href="college-joke.html" class="current">校园风云</a> </div>
      <h1>校园风云</h1>
    </div>
      ...
      <div class="row-fluid">
        <div class="span12">
          <div class="widget-box">
            ...
            <form  action ="${pageContext.request.contextPath }/admins/findArticlesByCondition.action?category=校园风云" method="post" role="form">
            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered data-table">
				...
				<tr class="gradeX">
					...
					&nbsp;<a href="${pageContext.request.contextPath }/admins/delArticlesCustomByAid.action?aid=${articlesCustom.aid}&category=校园风云">删除</a>
              ...
              <div class="pagination alternate text-center">
				...
				<td colspan="9" align="center">
					<!-- 显示首页 --> <c:if test="${pageBean.pNum==1}">
						...
						<a
							href="${pageContext.request.contextPath }/admins/findSchoolSituation.action?pNum=1">首页</a>
						<a
							href="${pageContext.request.contextPath }/admins/findSchoolSituation.action?pNum=${pageBean.pNum-1 }">上一页</a>
               ...
               ${i}
						...
						<c:if test="${pageBean.pNum!=i}">
							<a
								href="${pageContext.request.contextPath }/admins/findSchoolSituation.action?pNum=${i} ">${i}
							</a>
						</c:if>
						...
						<a
							href="${pageContext.request.contextPath }/admins/findSchoolSituation.action?pNum=${pageBean.pNum+1}">下一页</a>
						<a
							href="${pageContext.request.contextPath }/admins/findSchoolSituation.action?pNum=${ pageBean.totalPageNum}">尾页</a>
