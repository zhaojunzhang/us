...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [
                     ...
                     ['bold', 'italic','imagecenter', 'simpleupload','insertimage','link','time', //鏃堕棿
                      'date', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset', 'blockquote', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc']
                 ]
        ...
        ,initialFrameWidth:1090  //鍒濆鍖栫紪杈戝櫒瀹藉害,榛樿1000
